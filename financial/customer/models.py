...
class Customer(models.Model):
    ...
    payterms = models.CharField(max_length=20, blank=True, null=True)
    creditterm = models.ForeignKey('creditterm.Creditterm', related_name='creditterm_id', null=True, blank=True)
